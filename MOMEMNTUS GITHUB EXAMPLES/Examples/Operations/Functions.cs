...
namespace Examples.Operations
{
  public class Functions : Base
  {
    ...
    public FunctionsModel InsertIndentedFunctionWithRequirements(string orgCode, int eventID, int functionID, string functionDescription, string statusCode, string coordinator, string requirements)
    {
      var myFunction = new FunctionsModel
      {
        OrganizationCode = orgCode,
    ...
    public FunctionsModel EditWithRequirements(string orgCode, int EventID, int functionID, string newText, string requirements)
    {
      var myFunction = apiClient.Endpoints.Functions.Get(orgCode, EventID, functionID);

      myFunction.Description = newText;
      myFunction.Requirements = requirements;

      return apiClient.Endpoints.Functions.Update(myFunction);
    }

    public FunctionsModel EditWithouthRequirements(string orgCode, int EventID, int functionID, string newText)
    {
      var myFunction = apiClient.Endpoints.Functions.Get(orgCode, EventID, functionID);
