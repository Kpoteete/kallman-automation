...
namespace Examples.Operations
{
  public class ExternalInvoiceDetails : Base
  {
    ...
    /// <summary>
    /// Search for all detail lines for a specific header ID
    /// </summary>
    public SearchResponse<ExternalInvoiceDetailsModel> SearchByHeaderID(int headerIdExt)
    {
      return apiClient.Endpoints.ExternalInvoiceDetails.Search($"{nameof(ExternalInvoiceDetailsModel.HeaderIDExt)} eq {headerIdExt}");
    }
