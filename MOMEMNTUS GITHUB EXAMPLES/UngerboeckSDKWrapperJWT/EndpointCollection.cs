...
namespace Ungerboeck.Api.Sdk
{
  public class EndpointCollection
  {
    ...
    private ActivityTypes ActivityTypesApi;
    public ActivityTypes ActivityTypes
    {
      get
      {
        if (ActivityTypesApi == null) ActivityTypesApi = new ActivityTypes(client);
    ...
    private EventRegistrantTypes EventRegistrantTypesApi;
    public EventRegistrantTypes EventRegistrantTypes
    {
      get
      {
        if (EventRegistrantTypesApi == null) EventRegistrantTypesApi = new EventRegistrantTypes(client);
        return EventRegistrantTypesApi;
      }
    }
    ...
    private EventRegistrationPriceLists EventRegistrationPriceListsApi;
    public EventRegistrationPriceLists EventRegistrationPriceLists
    {
      get
      {
        if (EventRegistrationPriceListsApi == null) EventRegistrationPriceListsApi = new EventRegistrationPriceLists(client);
        return EventRegistrationPriceListsApi;
      }
    }
    ...
    private FunctionItems FunctionItemsApi;
    public FunctionItems FunctionItems
    {
      get
      {
        if (FunctionItemsApi == null) FunctionItemsApi = new FunctionItems(client);
        return FunctionItemsApi;
      }
    }
    ...
    private Merchandise MerchandiseApi;
    public Merchandise Merchandise
    {
      get
      {
        if (MerchandiseApi == null) MerchandiseApi = new Merchandise(client);
        return MerchandiseApi;
      }
    }
    ...
    private PaymentPlanItems PaymentPlanItemsApi;
    public PaymentPlanItems PaymentPlanItems
    {
      get
      {
        if (PaymentPlanItemsApi == null) PaymentPlanItemsApi = new PaymentPlanItems(client);
        return PaymentPlanItemsApi;
      }
    }
    ...
    private PaymentSchedules PaymentSchedulesApi;
    public PaymentSchedules PaymentSchedules
    {
      get
      {
        if (PaymentSchedulesApi == null) PaymentSchedulesApi = new PaymentSchedules(client);
        return PaymentSchedulesApi;
      }
    }

    private ServiceOrderItemTaxes ServiceOrderItemTaxesApi;
    public ServiceOrderItemTaxes ServiceOrderItemTaxes
    {
      get
      {
        if (ServiceOrderItemTaxesApi == null) ServiceOrderItemTaxesApi = new ServiceOrderItemTaxes(client);
        return ServiceOrderItemTaxesApi;
      }
    }
    ...
    private PaymentPlanItemTaxes PaymentPlanItemTaxesApi;
    public PaymentPlanItemTaxes PaymentPlanItemTaxes
    {
      get
      {
        if (PaymentPlanItemTaxesApi == null) PaymentPlanItemTaxesApi = new PaymentPlanItemTaxes(client);
        return PaymentPlanItemTaxesApi;
      }
    }
    ...
    private RegistrationFunctions RegistrationFunctionsApi;
    public RegistrationFunctions RegistrationFunctions
    {
      get
      {
        if (RegistrationFunctionsApi == null) RegistrationFunctionsApi = new RegistrationFunctions(client);
        return RegistrationFunctionsApi;
      }
    }
    ...
    private RegistrationPromoCodes RegistrationPromoCodesApi;
    public RegistrationPromoCodes RegistrationPromoCodes
    {
      get
      {
        if (RegistrationPromoCodesApi == null) RegistrationPromoCodesApi = new RegistrationPromoCodes(client);
        return RegistrationPromoCodesApi;
      }
    }

    private RegistrationSetups RegistrationSetupsApi;
    public RegistrationSetups RegistrationSetups
    {
      get
      {
        if (RegistrationSetupsApi == null) RegistrationSetupsApi = new RegistrationSetups(client);
        return RegistrationSetupsApi;
      }
    }

    private EventRegistrationPromoCodes EventRegistrationPromoCodesApi;
    public EventRegistrationPromoCodes EventRegistrationPromoCodes
    {
      get
      {
        if (EventRegistrationPromoCodesApi == null) EventRegistrationPromoCodesApi = new EventRegistrationPromoCodes(client);
        return EventRegistrationPromoCodesApi;
      }
    }
    ...
    private RegistrantTypes RegistrantTypesApi;
    public RegistrantTypes RegistrantTypes
    {
      get
      {
        if (RegistrantTypesApi == null) RegistrantTypesApi = new RegistrantTypes(client);
        return RegistrantTypesApi;
      }
    }

    private RegistrationRates RegistrationRatesApi;
    public RegistrationRates RegistrationRates
    {
      get
      {
        if (RegistrationRatesApi == null) RegistrationRatesApi = new RegistrationRates(client);
        return RegistrationRatesApi;
      }
    }

    private RegistrationDependentItems RegistrationDependentItemsApi;
    public RegistrationDependentItems RegistrationDependentItems
    {
      get
      {
        if (RegistrationDependentItemsApi == null) RegistrationDependentItemsApi = new RegistrationDependentItems(client);
        return RegistrationDependentItemsApi;
      }
    }
