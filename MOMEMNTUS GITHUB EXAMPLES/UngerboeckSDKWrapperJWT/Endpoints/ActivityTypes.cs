...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ActivityTypes : Base<ActivityTypesModel>
  {
    protected internal ActivityTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<ActivityTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ActivityTypesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.ActivityTypes options = null)
    {
    ...
    public ActivityTypesModel Add(ActivityTypesModel model, Ungerboeck.Api.Models.Options.Subjects.ActivityTypes options = null)
    {
    ...
    public ActivityTypesModel Update(ActivityTypesModel model, Ungerboeck.Api.Models.Options.Subjects.ActivityTypes options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.ActivityTypes options = null)
    {
