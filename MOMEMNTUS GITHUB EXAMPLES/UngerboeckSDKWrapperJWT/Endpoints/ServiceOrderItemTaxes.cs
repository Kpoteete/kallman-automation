...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class ServiceOrderItemTaxes : Base<ServiceOrderItemTaxesModel>
  {
    protected internal ServiceOrderItemTaxes(ApiClient api) : base(api) { }
    ...
    public new Models.Search.SearchResponse<ServiceOrderItemTaxesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public ServiceOrderItemTaxesModel Get(string orgCode, int orderLine, int orderNumber, int sequenceNumber, Models.Options.Subjects.ServiceOrderItemTaxes options = null)
    {
      return base.Get(new { orgCode, orderLine, orderNumber, sequenceNumber }, options);
    }
  }
}