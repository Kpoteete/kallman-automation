...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrationPromoCodes : Base<RegistrationPromoCodesModel>
  {
    protected internal RegistrationPromoCodes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationPromoCodesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationPromoCodesModel Get(string orgCode, int? sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationPromoCodes options = null)
    {
    ...
    public RegistrationPromoCodesModel Update(RegistrationPromoCodesModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationPromoCodes options = null)
    {
    ...
    public RegistrationPromoCodesModel Add(RegistrationPromoCodesModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationPromoCodes options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, int? sequenceNumber, Ungerboeck.Api.Models.Options.Subjects.RegistrationPromoCodes options = null)
    {
