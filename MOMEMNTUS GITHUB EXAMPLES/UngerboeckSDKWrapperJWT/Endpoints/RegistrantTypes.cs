...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrantTypes : Base<RegistrantTypesModel>
  {
    protected internal RegistrantTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrantTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrantTypesModel Get(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.RegistrantTypes options = null)
    {
      return base.Get(new { orgCode, code }, options);
    }
    ...
    public RegistrantTypesModel Add(RegistrantTypesModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrantTypes options = null)
    {
    ...
    public RegistrantTypesModel Update(RegistrantTypesModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrantTypes options = null)
    {
    ...
    public HttpResponseMessage Delete(string orgCode, string code, Ungerboeck.Api.Models.Options.Subjects.RegistrantTypes options = null)
    {
      return base.Delete(new { orgCode, code }, options);
    }
  }
}
