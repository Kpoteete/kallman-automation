...
{
  public class RegistrationFunctions : Base<RegistrationFunctionsModel> 
  {
    protected internal RegistrationFunctions(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationFunctionsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationFunctionsModel Get(string orgCode, int eventID, int functionID, Ungerboeck.Api.Models.Options.Subjects.RegistrationFunctions options = null)
    {
      return base.Get(new { orgCode, eventID, functionID }, options);
    }
    ...
    public RegistrationFunctionsModel Add(RegistrationFunctionsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationFunctions options = null)
    {
    ...
    public RegistrationFunctionsModel Update(RegistrationFunctionsModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationFunctions options = null)
    {
      return base.Update(new { model.OrganizationCode, model.EventID, model.FunctionID }, model, options);
    }
    ...
    public HttpResponseMessage Delete(string orgCode, int eventID, int functionID, Ungerboeck.Api.Models.Options.Subjects.RegistrationFunctions options = null)
    {
      return base.Delete(new { orgCode, eventID, functionID }, options);
    }
  }
}
