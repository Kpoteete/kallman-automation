...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class VoucherApprovals : Base<VoucherApprovalsModel>
  {
    protected internal VoucherApprovals(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<VoucherApprovalsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public VoucherApprovalsModel Get(string orgCode, int voucherNumber, int voucherDistrSeq, int sequence, Ungerboeck.Api.Models.Options.Subjects.VoucherApprovals options = null)
    {
      return base.Get(new { orgCode, voucherNumber, voucherDistrSeq, sequence }, options);
    }
    ...
    public VoucherApprovalsModel Add(VoucherApprovalsModel model, Ungerboeck.Api.Models.Options.Subjects.VoucherApprovals options = null)
    {
