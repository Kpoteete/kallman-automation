...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RegistrationRates : Base<RegistrationRatesModel>
  {
    protected internal RegistrationRates(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RegistrationRatesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RegistrationRatesModel Get(string orgCode, int seqNbr, int minMaxSeqNbr, Ungerboeck.Api.Models.Options.Subjects.RegistrationRates options = null)
    {
      return base.Get(new { orgCode, seqNbr, minMaxSeqNbr }, options);
    }
    ...
    public RegistrationRatesModel Update(RegistrationRatesModel model, Ungerboeck.Api.Models.Options.Subjects.RegistrationRates options = null)
    {
      return base.Update(new { model.OrganizationCode, model.SequenceNumber, model.RegistrationItemCapacitySeqNbr }, model, options); 
    }
