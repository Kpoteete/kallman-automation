...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class InventoryTransactions : Base<InventoryTransactionsModel>
  {
    protected internal InventoryTransactions(ApiClient api) : base(api) { }
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<InventoryTransactionsModel> Search(string searchOData, Search options = null)
    {
    ...
    public InventoryTransactionsModel Get(int uniqueId, Ungerboeck.Api.Models.Options.Subjects.InventoryTransactions options = null)
    {
      return base.Get(new { uniqueId }, options);
    }

    /// <summary>
    /// Use this endpoint to add a new entry for this subject.
    /// </summary>
    /// <param name="model">The InventoryTransactionsModel to add.</param>
    /// <param name="options">This contains optional configurations.</param>
    /// <returns>The added InventoryTransactionsModel.</returns>
    public InventoryTransactionsModel Add(InventoryTransactionsModel model, Ungerboeck.Api.Models.Options.Subjects.InventoryTransactions options = null)
    {
