...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PaymentSchedules : Base<PaymentSchedulesModel>
  {
    protected internal PaymentSchedules(ApiClient api) : base(api) { }
    ...
    public new Models.Search.SearchResponse<PaymentSchedulesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public PaymentSchedulesModel Get(string orgCode, string scheduleCode, Models.Options.Subjects.PaymentSchedules options = null)
    {
      return base.Get(new { orgCode, scheduleCode }, options);
    }
  }
}
