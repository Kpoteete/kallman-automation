...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventRegistrantTypes : Base<EventRegistrantTypesModel>
  {
    protected internal EventRegistrantTypes(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventRegistrantTypesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventRegistrantTypesModel Get(string orgCode, string type, int eventId, Ungerboeck.Api.Models.Options.Subjects.EventRegistrantTypes options = null)
    {
      return base.Get(new { orgCode, type, eventId }, options);
    }
    ...
    public EventRegistrantTypesModel Add(EventRegistrantTypesModel model, Ungerboeck.Api.Models.Options.Subjects.EventRegistrantTypes options = null)
    {
    ...
    public EventRegistrantTypesModel Update(EventRegistrantTypesModel model, Ungerboeck.Api.Models.Options.Subjects.EventRegistrantTypes options = null)
    {
      return base.Update(new { model.OrganizationCode, model.Type, model.EventID }, model, options);
    }
    ...
    public HttpResponseMessage Delete(string orgCode, string type, int eventId, Ungerboeck.Api.Models.Options.Subjects.EventRegistrantTypes options = null)
    {
      return base.Delete(new { orgCode, type, eventId }, options);
    }
  }
}
